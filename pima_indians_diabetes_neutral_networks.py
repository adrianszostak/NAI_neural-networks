...
mlp2 = MLPClassifier(
    hidden_layer_sizes=(120, 84, 50, 30),
    max_iter=30,
    learning_rate_init=0.1,
)
...
print("Training smaller hidden_layer_sizes set score: %f" % mlp.score(X_train, y_train))
print("Test smaller hidden_layer_sizes set score: %f" % mlp.score(X_test, y_test))
print("Training bigger hidden_layer_sizes set score: %f" % mlp2.score(X_train, y_train))
print("Test bigger hidden_layer_sizes set score: %f" % mlp2.score(X_test, y_test))